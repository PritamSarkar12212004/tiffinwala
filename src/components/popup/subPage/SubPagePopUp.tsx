...
const SubPagePopUp = ({ setIsSubPagePopUpVisible }: { setIsSubPagePopUpVisible: (visible: { status: boolean, message: string }) => void }) => {
    const { isSubPagePopUpVisible } = userContext();
